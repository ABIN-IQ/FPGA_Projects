...
Comparing the power reports before and after implementation shows that power optimization reduces switching activity, particularly in clock signals, leading to a more efficient distribution of dynamic power, while the overall power change remains minimal due to the dominance of static power.

![Output waveform](Images/power.png)
